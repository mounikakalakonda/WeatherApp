...
class ProjectService {
    constructor($hooksService, $packageManager, $errors, $fs, $logger, $pacoteService, $projectDataService, $projectHelper, $projectNameService, $projectTemplatesService, $staticConfig, $tempService) {
