...
class GradleBuildArgsService {
    constructor($androidToolsInfo, $hooksService, $analyticsService, $staticConfig, $logger) {
    ...
    getBuildTaskArgs(buildData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.$hooksService.executeBeforeHooks('build-task-args', { hookArgs: { args } });
            return args;
        });
    }
